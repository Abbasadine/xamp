...
define( 'POWERPACK_ELEMENTS_VER', '2.9.23' );
...
function ES_powerpack_update_checker() {

	$ES_json_url 	= 'https://esdownload.ir/json/powerpack23423462454.json' ;
	$ES_plugin_slug = 'powerpack' ;
...
add_action( 'admin_init', 'ES_powerpack_update_checker', 99 );